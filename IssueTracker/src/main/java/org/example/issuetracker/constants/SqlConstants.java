...
public class SqlConstants {
	...
	public static final String SELECT_BUILD_BY_PROJECT_ID = "SELECT id, name, projectid FROM builds WHERE projectid=?";
...
//			+ "WHERE issues.assignee=?";
	...
	public static final int SELECT_ISSUE_RET_BUILDID_INDEX = 14;
...
//	public static final int SELECT_ISSUE_RET_ASROLE_INDEX = 37;
	...
	public static final String SELECT_NEW_STATUSES = "SELECT id, name FROM statuses WHERE id IN(1, 2)";
//	public static final String COMMA = ",";
//	public static final String CLOSING_PARENTHESIS = ")";
	public static final String SELECT_ALL_STATUSES = "SELECT id, name FROM statuses";
	...
	public static final String UPDATE_ISSUE = "UPDATE issues SET modifydate=CURDATE(), modifiedby=?, summary=?, description=?, status=?, resolution=(SELECT id FROM resolutions WHERE name=?), type=(SELECT id FROM types WHERE name=?), priority=(SELECT id FROM priorities WHERE name=?), project=?, buildfound=?, assignee=? "
			+ "WHERE issues.id=?";
	public static final int UPDATE_ISSUE_MODIFIEDBY_INDEX = 1;
	public static final int UPDATE_ISSUE_SUMMARY_INDEX = 2;
	public static final int UPDATE_ISSUE_DESCRIPTION_INDEX = 3;
	public static final int UPDATE_ISSUE_STATUS_INDEX = 4;
	public static final int UPDATE_ISSUE_RESOLUTION_INDEX = 5;
	public static final int UPDATE_ISSUE_TYPE_INDEX = 6;
	public static final int UPDATE_ISSUE_PRIORITY_INDEX = 7;
	public static final int UPDATE_ISSUE_PROJECT_INDEX = 8;
	public static final int UPDATE_ISSUE_BUILD_INDEX = 9;
	public static final int UPDATE_ISSUE_ASSIGNEE_INDEX = 10;
	public static final int UPDATE_ISSUE_ID_INDEX = 11;
	public static final String SELECT_ROW_COUNT = "SELECT COUNT(*) AS count FROM ";
	public static final int SELECT_ROW_COUNT_RET_COUNT_INDEX = 1;
	public static final String SELECT_ISSUES_COUNT_BY_ASSEGNEE = "SELECT COUNT(*) AS count FROM issues WHERE assignee=?";
	public static final int SELECT_ISSUES_COUNT_ASSEGNEE_INDEX = 1;
	public static final int SELECT_ISSES_COUNT_RET_COUNT_INDEX = 1;
}
